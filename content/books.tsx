...
export const books: Book[] = [
  {
    ...
    "hasNotes": true,
    "isReading": true,
    "content": "<ul>\n<li>My all-time favorite book — House of Leaves, holds the dearest place in my heart. <blockquote>\n<p>I first read it at 15, as a confused shell of myself.<br>It forever changed the course of not only how I view literature, but how I view my life.<br>Even what I want my own art to breathe towards, one day.</p>\n</blockquote>\n</li>\n</ul>\n<h3><em>I wanted to change the world with my art since the first stumblings I ever had, I wanted to know that I could be as important alongside it.</em></h3>\n<blockquote>\n<p>THIS HAS ALWAYS BEEN WHAT I WANTED. </p>\n</blockquote>\n"
  },
  {
    ...
    "hasNotes": true,
    "isReading": false,
    "content": "<ul>\n<li>Physical based rendering has always been something I&#39;m interested in,<br>hoping to one day make good on the promise to learn more about the subject matter.</li>\n</ul>\n"
  },
  {
    "slug": "timewar",
